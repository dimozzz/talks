...
\begin{tikzpicture}
    ...
    \only<2-3>{
        ...
        \end{scope}
        \node[blue] at (-0.5, -0.7) {Монотонные <<схемы>>};
    }
    ...
    \pause
    \node[opacity = 0, inner sep = 0pt] at (-7, -0.5) {\includegraphics[width = 0.15\textwidth]{pics/firehead.png}};
