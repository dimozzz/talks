...
\begin{frame}{Generalization. Trivial way}
    ...
    \begin{columns}[t]
		\begin{column}{0.7\textwidth}
            \onslide<2->{Structure of the protocol $\underset{\text{KW}}{\Leftrightarrow}$ structure of formula.}
            
            \onslide<2->{Structure of the protocol $\underset{\text{IPU}}{\Leftarrow}$ structure of formula.}

            \onslide<3->{Can we merge some vertex?}
